...
class OPF_myForm {
	 ...
	 */
		...
		public function addFreeObject ($id, $etq = '', $value = ''){
			$id = $this->getColspanRowspan($id);
			$this->Objects['field']['whitespace_'.$id] = 'whitespace'.$this->Separador.$id.$this->Separador.$etq.$this->Separador.$value;
		...
		public function addButton ($strName, $strLabel = '', $strSrcImg = ''){
			...
			$Cadena   = 'button'.$this->Separador.$name.$this->Separador.$strLabel.$this->Separador.$strSrcImg;
