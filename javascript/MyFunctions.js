...
function CallCalendar (campo_fecha, format, lanzador){
       Calendar.setup({inputField:campo_fecha, ifFormat:format, button:lanzador});
}
...
*/
	...
	xajax.commands['mw:aw'] = function( args )
	{
		...
		clleft	= (                     ( (arrayPageSize[2] -  width ) / 2 ) );
