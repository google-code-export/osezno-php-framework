<div id="message_box">
<span><table border="1" cellpadign="0" cellspacing="0" height="{height_msg_box}" width="{width_msg_box}">
		<tr>
		...
		<tr>
			...
			<td class="center_middle">
				...
				<table height="100%" width="100%" border="0" cellpadign="0" cellspacing="0" class="center_middle">
					<tr>
						<td>&nbsp;</td>
						<td valign="top">
							<table height="100%" border="0" cellpadign="0" cellspacing="0" border="0">
								<tr>
									<td width="15%" align="center" valign="middle"><img src="msg_box_info.png"></td>
