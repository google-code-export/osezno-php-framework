CREATE TABLE IF NOT EXISTS `ess_bit` (
  ...
  `ip` varchar(50) COLLATE latin1_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ess_master_tables` (
  ...
  `name` varchar(50) COLLATE latin1_bin NOT NULL COMMENT 'Table name',
  `description` text COLLATE latin1_bin NOT NULL COMMENT 'Table description',
  `user_id` int(11) NOT NULL COMMENT 'User id',
  `datetime` datetime NOT NULL COMMENT 'Date of registration or update',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_bin COMMENT='Maestro de tablas' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `ess_master_tables_detail` (
  ...
  `item_cod` varchar(50) COLLATE latin1_bin NOT NULL COMMENT 'Code',
  `item_desc` text COLLATE latin1_bin NOT NULL COMMENT 'Description',
  `user_id` int(11) NOT NULL COMMENT 'User id',
  `datetime` datetime NOT NULL COMMENT 'Date of registration or update',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `master_tables_id` (`master_tables_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_bin COMMENT='Detalle de las tablas' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `ess_menu` (
  ...
  `icon` varchar(20) COLLATE latin1_bin NOT NULL,
  `url` text COLLATE latin1_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ess_profiles` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK',
  `name` varchar(50) COLLATE latin1_bin NOT NULL COMMENT 'Profile name',
  `description` text COLLATE latin1_bin NOT NULL COMMENT 'Profile description',
  `user_id` int(11) NOT NULL COMMENT 'User',
  `datetime` datetime NOT NULL COMMENT 'Fecha modificacion',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_bin COMMENT='Perfiles' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `ess_system_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'PK',
  `user_name` varchar(50) COLLATE latin1_bin NOT NULL COMMENT 'User name',
  `name` varchar(50) COLLATE latin1_bin NOT NULL COMMENT 'Name',
  `lastname` varchar(50) COLLATE latin1_bin NOT NULL COMMENT 'Lastname',
  `passwd` varchar(150) COLLATE latin1_bin NOT NULL COMMENT 'Passwd',
  `status` enum('1','2') COLLATE latin1_bin NOT NULL COMMENT 'Status',
  `profile_id` int(11) NOT NULL COMMENT 'Proflie',
  `datetime` datetime NOT NULL COMMENT 'Date of registration or update',
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_name` (`user_name`),
  KEY `profile_id` (`profile_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COLLATE=latin1_bin COMMENT='Users' AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `ess_usronline` (
  ...
  `usuario_id` int(11) NOT NULL,
  `ip` varchar(50) COLLATE latin1_bin NOT NULL,
  `sesname` varchar(150) COLLATE latin1_bin NOT NULL,
